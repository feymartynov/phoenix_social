defmodule PhoenixSocial.Integration.Wall.CommentLiveUpdateTest do
  ...
  test "Add a comment", %{user: user, friend: friend} do
    # the user signs in, goes to the friends' profile and waits for updates
    ...
    # the user should see the friend's comment on the wall without page refresh
    in_browser_session :user_session, fn ->
