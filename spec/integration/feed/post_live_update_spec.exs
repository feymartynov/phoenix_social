defmodule PhoenixSocial.Integration.Feed.PostLiveUpdateSpec do
  ...
  it "adds a post" do
    ...
    in_browser_session :user_session, fn ->
      assert find_element(:id, "feed") |> inner_text =~ text
    end
  end
  ...
  it "deletes a post" do
    ...
    in_browser_session :user_session, fn ->
      refute find_element(:id, "feed") |> inner_text =~ post.text
    end
  end
end
